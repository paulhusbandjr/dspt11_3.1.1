...
When you don't know what specific values, and value types, might end up being implemented. Example, a role-playing game where a new class or race is added.  
- What is "NewSQL", and what is it trying to achieve?
NewSQL is a relational database system that attempts to take the scalability of NoSQL and combine it with the ACID characteristics of standard SQL databases.
